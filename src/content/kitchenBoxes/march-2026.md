...
month: "March"
year: 2026
summary: "Spring florals meet citrus fizz. Sakura is back, the HIWTK DNA lives on, and this might be one of the strongest boxes this year."
heroImage: "/images/boxes/march-2026-hero.jpg"
groupShot: "/images/boxes/march-2026-group.jpg"
tiktokUrl: "https://www.tiktok.com/@lushiesam"
tiktokEmbedId: ""
products:
  - name: "Sakura Bath Bomb"
    type: "Bath Bomb"
    description: "Cherry blossom and ylang ylang fizzer with actual flower petals in it. The pink bathwater is unreal."
  ...
  - name: "Lime Pastille Shower Jelly"
    ...
    image: "/images/products/lime-pastille-jelly.jpg"
    scent: "Lime, neroli, grapefruit"
    highlight: false
  - name: "Honey Bee Soap"
    type: "Soap"
    description: "Honeycomb-shaped soap with real honey and oat milk. Creamy lather, v v sweet scent."
    image: "/images/products/honey-bee-soap.jpg"
    scent: "Honey, oat milk, sweet orange"
    highlight: true
    nostalgiaNote: "This is HIWTK energy through and through. If you missed Honey I Washed The Kids, this is your moment."
  - name: "Twilight Body Lotion"
    type: "Body Lotion"
    description: "Lavender and tonka bean body lotion in deep purple. Proper bedtime ritual stuff."
    image: "/images/products/twilight-lotion.jpg"
    scent: "Lavender, tonka bean, benzoin"
    highlight: false
  - name: "Avobath Bubble Bar"
    type: "Bubble Bar"
    description: "Lemongrass and bergamot bubble bar. Makes the water emerald green. Iconic."
    image: "/images/products/avobath-bubble-bar.jpg"
    scent: "Lemongrass, bergamot, olive oil"
    highlight: false
screenshots:
...
Twilight body lotion is perfect for winding down. Rich but not heavy, and the lavender-tonka combo is genuinely sleep-inducing. Been using it every night since the box arrived.

### Verdict

One of the stronger Kitchen boxes in recent memory. Two products with serious nostalgia value, great variety of formats, and not a single dud. **A proper solid month.**

### Community vibe

This one went down really well. The HIWTK connection in the Honey Bee soap had people losing it, and Sakura fans were v v happy to see it back. Defo a community favourite month.
